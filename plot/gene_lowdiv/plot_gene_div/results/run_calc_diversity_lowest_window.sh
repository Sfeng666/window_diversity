...
min_count=$2
win_len=$3
wd=/home/siyuan/jobs/suzukii_WGS/genetic_diff/window_diversity/plot/gene_lowdiv/plot_gene_div/results/winlen_$win_len\_mincov_$mincov\_mincount_$min_count
sd=/home/siyuan/jobs/suzukii_WGS/genetic_diff/window_diversity/plot/gene_lowdiv/plot_gene_div/scripts
script=$sd/win_div_by_filtered_sites.py
calc_script=$sd/calc_diversity_lowest_window.py
...
win_coords=/home/siyuan/jobs/suzukii_WGS/genetic_diff/window_diversity/plot/gene_lowdiv/plot_gene_div/selected_windows.txt
...
bash $sd/calc_diversity_lowest_window.sh \
-w $wd \
-s $dir_snp \
-m $dir_mpileup \
-c $win_coords \
